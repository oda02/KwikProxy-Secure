...
use ipc::commands::{
    ...
    begin_subscription_epoch, check_routing_conflicts, connect, connection_ping,
    count_recent_crashes, delete_subscription_cache, discard_proxy_backup, disconnect,
    disconnect_force_restore_proxy, export_diagnostics, export_settings_to_documents,
    fetch_subscription, geofiles_refresh, geofiles_status, get_hwid, get_recovery_state,
    get_routing_table, get_servers, get_subscription_meta, hide_floating_window, is_xray_running,
    kill_switch_apply, kill_switch_heartbeat, leak_test, list_processes, load_subscription_cache,
    mihomo_delay_test, mihomo_proxies, mihomo_select_proxy, ping_mihomo_nodes, ping_servers,
    read_xray_log, recover_network, restore_proxy_backup, restore_proxy_backup_confirmed,
    routing_add_static, routing_add_static_from_url, routing_add_url, routing_list,
    routing_refresh, routing_remove, routing_set_active, save_subscription_cache,
    secure_storage_delete, secure_storage_get, secure_storage_set, set_servers,
    show_floating_window, tray_set_status, KillSwitchState,
};
use vpn::MihomoState;
...
pub fn run() {
    ...
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            connect,
            disconnect,
            disconnect_force_restore_proxy,
            is_xray_running,
            fetch_subscription,
            ...
            restore_proxy_backup_confirmed,
